...
localparam TRES = 3'd1; // ????????????? ???????? ?????? ??????????
localparam TMEM = 3'd2; // ???????? ?????? ??????
localparam TDT = 3'd3; // ???????? ?????? ??????????
localparam TCR = 3'd4; // ???????? ??????? CR
localparam TLF = 3'd5; // ???????? ??????? LF

reg [2:0] RES_CT; // ??????? ???????? ??????????
wire [2:0] CT_MX; // ??????????? ???????? ???????? RES_CT
reg [6:0] END_ADDR; // ???????? ?????????? ?????? ????????? ? ???
reg [19:0] RES_DATA; // ?????? ?????????? why 12 bits tho, in pres it is 16
reg RES_FLG; // ???? ?????????? ?????????? ?????????????? ????????
...
assign CT_MX = (RES_DATA_R[36:34] == 3'b001) ? 3'b011 : 3'b000; // Err or smth [19:16] [15:12] [11:8] [7:4] [3:0]
